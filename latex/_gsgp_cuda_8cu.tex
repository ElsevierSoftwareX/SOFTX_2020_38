...
printf(\char`\"{}\textbackslash{}n Starting Gsgp\+Cuda \textbackslash{}n\textbackslash{}n\char`\"{});

read\+Config\+File(\&config); /$\ast$!$<$ reading the parameters of the algorithm
...
Definition at line 36 of file Gsgp\+Cuda.\+cu.
